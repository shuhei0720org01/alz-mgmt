...
Azure Landing Zonesの「目」と「耳」を作っていくよ。

- **Log Analytics Workspace**：全てのログを集約する場所
- **Data Collection Rules（DCR）**：どのログを集めるかのルール
- **Managed Identity**：パスワード不要の認証

この3つが揃うことで、Azure環境全体の監視が可能になる。
