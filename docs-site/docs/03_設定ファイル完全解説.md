# 03. 設定ファイル完全解説 - platform-landing-zone.auto.tfvars


## このChapterでやること

このプロジェクトで一番重要なファイル、`platform-landing-zone.auto.tfvars`を1行ずつ解説していきます。

このファイルは約500行ありますが、怖がらなくて大丈夫です。
実は同じパターンの繰り返しが多いので、パターンさえ覚えれば読めるようになります。
...
詳細は [Chapter 06: 設定テンプレート](./06_設定テンプレート.md) で解説します。
...
**DeployIfNotExists** = 「もし有効じゃなかったら、自動で有効にする」
...
**所要時間**: 60分  
**難易度**: ★★★★★  
**前**: [02_プロジェクト構造.md](./02_プロジェクト構造.md)  
**次**: [04_変数定義.md](./04_変数定義.md)
