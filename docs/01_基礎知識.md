...
Landing Zonesは、**こういう問題を最初から防ぐ仕組み**です。
...
- A: 作れるけど、1社1テナントが基本。M&Aとかで増えることはある。
...
つまり、このコードを使えば、  
**Microsoftが推奨する「ちゃんとした企業向けAzure環境」が自動で作れる**ということです。
